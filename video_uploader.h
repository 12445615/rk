...
#define VIDEO_UPLOADER_HTTP_LOW_SPEED_LIMIT_BPS 1024L
#define VIDEO_UPLOADER_HTTP_LOW_SPEED_TIME_SEC 15L

#define VIDEO_UPLOADER_IDLE_INTERVAL_MS 200
#define VIDEO_UPLOADER_RETRY_BASE_MS    2000
#define VIDEO_UPLOADER_RETRY_MAX_MS     20000
